...
class MenuServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->publishes([
            __DIR__ . '/../assets' => public_path('vendor/mykholy-menu'),
        ], 'public');
    ...
    {
        $this->app->bind('mykholy-menu', function () {
            return new WMenu();
        });

        $this->app->make('Mykholy\Menu\Controllers\MenuController');
