...
<script type="text/javascript" src="{{asset('vendor/mykholy-menu/scripts.js')}}"></script>
<script type="text/javascript" src="{{asset('vendor/mykholy-menu/scripts2.js')}}"></script>
<script type="text/javascript" src="{{asset('vendor/mykholy-menu/menu.js')}}"></script>